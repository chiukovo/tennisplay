            ...
            <div v-for="event in paginatedEvents" :key="event.id" 
                ...
                <div class="flex items-center justify-between mb-5">
                    <div class="flex items-center gap-2">
                        ...
                        <div v-if="event.is_organizer" class="bg-blue-600 text-white px-2.5 py-1.5 rounded-full text-[11px] font-black uppercase tracking-widest flex items-center gap-1 shadow-lg shadow-blue-100">
                            <app-icon name="star" class-name="w-3.5 h-3.5"></app-icon>
                            主辦
                        </div>
                        <div v-else-if="event.has_joined" class="bg-green-600 text-white px-2.5 py-1.5 rounded-full text-[11px] font-black uppercase tracking-widest flex items-center gap-1 shadow-lg shadow-green-100">
                    ...
                    <div class="flex items-center gap-1.5 bg-blue-50 px-3 py-1.5 rounded-full border border-blue-100">
                        <span class="text-[11px] font-black text-blue-500 uppercase tracking-tighter">缺</span>
                ...
                <div class="space-y-3.5 mb-7">
                    <div class="flex items-center gap-3">
                        ...
                        <div class="min-w-0">
                            ...
                            <div class="text-[11px] font-bold text-slate-500 uppercase tracking-widest">活動時間</div>
                        </div>
                    </div>
                    <div class="flex items-center gap-3">
                        ...
                        <div class="min-w-0">
                            ...
                            <div class="text-[11px] font-bold text-slate-500 uppercase tracking-widest">區域地點</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-auto pt-6 flex items-center justify-between gap-4">
                    ...
                    <div class="text-right">
                        <div class="text-[11px] font-black text-slate-500 uppercase tracking-widest leading-none mb-1">費用</div>
                ...
                <div class="mt-6 pt-5 border-t border-slate-50 flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-4">
                        <div class="flex items-center gap-1.5 text-slate-500">
                            ...
                            <span class="text-[11px] font-black">@{{ eventComments[event.id]?.length || 0 }}</span>
                        </div>
                        <div class="flex items-center gap-1.5 text-slate-500">
                            <app-icon name="users" class-name="w-3.5 h-3.5"></app-icon>
                            <span class="text-[11px] font-black">@{{ event.participants_count || 1 }}</span>
                        </div>
                    </div>
                </div>
            </div>
