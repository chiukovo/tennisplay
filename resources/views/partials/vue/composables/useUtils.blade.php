...
const useUtils = () => {
    ...
    return { toasts, showToast, removeToast, confirmDialog, showConfirm, hideConfirm, executeConfirm, formatDate, getUrl, formatLocalDateTime, formatEventDate, compressImage };
};
